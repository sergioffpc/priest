...
impl InstrExec for Lhu {
    ...
    #[inline(always)]
    #[cfg_attr(feature = "trace", tracing::instrument(name = "LHU", skip_all, fields(rd = tracing::field::Empty, rs1 = tracing::field::Empty, imm = tracing::field::Empty)))]
    fn call(&self, inst: u32, hart: &mut Hart, bus: &mut dyn Bus) -> anyhow::Result<()> {
        ...
        let val = bus.read16(addr)? as u64;
