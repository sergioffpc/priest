...
mod tests {
    ...
    fn encode_bltu(rs1: u32, rs2: u32, imm: i16) -> u32 {
        ...
        imm_12 | imm_10_5 | (rs2 << 20) | (rs1 << 15) | (0b110 << 12) | imm_4_1 | imm_11 | 0b1100011
    }
    ...
    fn exec(inst: u32, hart: &mut Hart, bus: &mut Mmap) {
        Bltu.call(inst, hart, bus)
            .expect("BLTU execution unexpectedly trapped");
    }
    ...
    fn bltu_taken() {
        ...
        hart.set_xreg(1, 3);
        hart.set_xreg(2, 5);
        exec(encode_bltu(1, 2, 16), &mut hart, &mut bus);
    ...
    fn bltu_equal() {
        ...
        hart.set_xreg(1, 7);
        hart.set_xreg(2, 7);
        exec(encode_bltu(1, 2, 12), &mut hart, &mut bus);
    ...
    fn bltu_negative_offset() {
        ...
        hart.set_xreg(1, 2);
        hart.set_xreg(2, 5);
        exec(encode_bltu(1, 2, -8), &mut hart, &mut bus);
    ...
    fn bltu_zero_offset() {
        ...
        hart.set_xreg(1, 5);
        hart.set_xreg(2, 5);
        exec(encode_bltu(1, 2, 0), &mut hart, &mut bus);
