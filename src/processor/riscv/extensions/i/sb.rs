...
impl InstrExec for Sb {
    ...
    #[inline(always)]
    #[cfg_attr(feature = "trace", tracing::instrument(name = "SB", skip_all, fields(rs1 = tracing::field::Empty, rs2 = tracing::field::Empty, imm = tracing::field::Empty)))]
    fn call(&self, inst: u32, hart: &mut Hart, bus: &mut dyn Bus) -> anyhow::Result<()> {
        ...
        bus.write8(addr, hart.xreg(rs2) as u8)?;
        hart.next_pc();
