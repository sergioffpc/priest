...
impl InstrExec for Sub {
    #[inline(always)]
    fn matches(&self, inst: u32) -> bool {
        inst & 0xfe00_707f == 0x4000_0033
    }

    #[inline(always)]
    #[cfg_attr(feature = "trace", tracing::instrument(name = "SUB", skip_all, fields(rd = tracing::field::Empty, rs1 = tracing::field::Empty, rs2 = tracing::field::Empty)))]
    fn call(&self, inst: u32, hart: &mut Hart, _bus: &mut dyn Bus) -> anyhow::Result<()> {
        ...
        let val = hart.xreg(rs1).wrapping_sub(hart.xreg(rs2));
